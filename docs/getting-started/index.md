...
<div class="docs-guide-cards">
  ...
  <div class="docs-guide-cards__item">
    <span class="docs-guide-cards__step">3. 実際に使ってみる</span>
    <span class="docs-guide-cards__text">CSV を読み込み，チェックを実行して結果を確認するまでの流れを確認します．</span>
    <a class="docs-guide-cards__link" href="{{ '/getting-started/demo/' | relative_url }}">使用デモを見る</a>
  </div>
</div>
